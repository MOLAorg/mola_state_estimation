#!/usr/bin/env python3
"""Release helper for mola_state_estimation.
...
PACKAGE_DIRS = ["mola_georeferencing", "mola_gtsam_factors", "mola_state_estimation", "mola_state_estimation_simple", "mola_state_estimation_smoother"]
